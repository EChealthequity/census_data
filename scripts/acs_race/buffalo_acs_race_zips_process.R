#==== Buffalo Zipcode - ACS Race Data Processing Script====#
...
zip_tracts_acs_race_16_20 <- get_acs(geography = "zcta",
...
write_csv(zip_tracts_acs_race_16_20, "data/acs/race/Buffalo Zips ACS Race Data - 2016-2020.csv")
...
cloud_saver("Buffalo Zip ACS Race Data 2016 to 2020", zip_tracts_acs_race_16_20)
