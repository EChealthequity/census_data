#==== Buffalo Zipcode - ACS Unemployment Data Processing Script====#
...
zip_tracts_acs_unemployment_16_20 <- get_acs(geography = "zcta",
...
write_csv(zip_tracts_acs_unemployment_16_20, "data/acs/employment/Buffalo Zips ACS Unemployment Data - 2016-2020.csv")
...
cloud_saver("Buffalo Zip ACS Unemployment Data 2016 to 2020", zip_tracts_acs_unemployment_16_20)
