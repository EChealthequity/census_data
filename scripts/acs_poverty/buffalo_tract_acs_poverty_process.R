...
buffalo_tracts_acs_poverty_16_20 <- get_acs(geography = "tract",
                                                 state = "NY",
                                                 county = "Erie",
                                                 year = 2020,
                                                 survey = "acs5",
...
write_csv(buffalo_tracts_acs_poverty_16_20, "data/acs/poverty/Buffalo Tracts ACS Poverty Data - 2016-2020.csv")
...
cloud_saver("Buffalo Tracts ACS Poverty Data 2016 to 2020", buffalo_tracts_acs_poverty_16_20)
