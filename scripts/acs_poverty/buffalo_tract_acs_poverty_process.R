#==== Buffalo Census Tracts - ACS Poverty Status Data Processing Script====#
...
buffalo_tracts_acs_poverty_15_19  <- buffalo_tracts_acs_poverty_15_19   %>%
  filter(tract %in% buffalo_tracts$tract) %>%
  mutate(tract = as.character(tract))


# Saving the data to the directory====
write_csv(buffalo_tracts_acs_poverty_15_19, "data/acs/poverty/Buffalo Tracts ACS Poverty Data - 2015-2019.csv")

# Writing out the geometry files for use in Tableau Public==
st_write(buffalo_tracts_acs_poverty_15_19, "data/acs/poverty/Buffalo Tracts ACS Poverty Data - 2015-2019.shp")
...
cloud_saver("Buffalo Tracts ACS Poverty Data 2015 to 2019", buffalo_tracts_acs_poverty_15_19)
