#==== Buffalo Census Tracts - ACS Total Population Data Processing Script====#
...
write_csv(buffalo_tracts_acs_total_16_20, "data/acs/race/Buffalo Tracts ACS Total Population Data - 2016-2020.csv")
