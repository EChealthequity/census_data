#==== Buffalo Zipcode - ACS Total Population Data Processing Script====#
...
zip_tracts_acs_total_16_20 <- get_acs(geography = "zcta",
...
write_csv(zip_tracts_acs_total_16_20, "data/acs/population/Buffalo Zips ACS Total Population Data - 2016-2020.csv")
...
cloud_saver("Buffalo Zip ACS Total Population Data 2016 to 2020", zip_tracts_acs_total_16_20)
