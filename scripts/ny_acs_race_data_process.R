#==== New York State - ACS Race Data Processing Script====#
...
ALL_NYS_race <- map(years, ~ get_acs(geography = "state",
                                          state = "NY",
                                          year = .x,
                                          survey = "acs1",
...
# Affixing names==
names(ALL_NYS_race) <- years

# Collapsing all NYS results into a single data frame====
nys_acs_race_10_19 <- bind_rows(ALL_NYS_race, .id = "year")

# Saving the data to the directory====
write_csv(nys_acs_race_10_19, "data/acs/race/NYS ACS Race Data - 2010-2019.csv")
...
cloud_saver("NYS ACS Race Data 2010 to 2019", nys_acs_race_10_19)
